...
print('N : The predicted result using SGD for Case 1, Case 2, Case 3 and Case 4 is: ')
print(result1)
...
print('Y : The predicted result using SGD for Case 5, Case 6, Case 7 and Case 8 is: ')
print(result2)
