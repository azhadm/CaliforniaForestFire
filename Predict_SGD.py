...
print("Accuracy for SGD is ", accuracy_score(y_test,y_pred)*100)
...
print('N : The predicted result using SGD for Case 1, Case 2, Case 3 and Case 4 is ', result1)
...
print('Y : The predicted result using SGD for Case 5, Case 6, Case 7 and Case 8 is ', result2)
